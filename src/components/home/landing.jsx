...
const Landing = () => {
  ...
  useEffect(() => {
    const rolesArray = ['React Native Developer', 'React js Developer'];
    setRoles(rolesArray);
      ...
      <img src={bg} alt="" className="bg" />
        <div className="landingContent">
          ...
          <p className="introPara">
            ...
            experience.<br/> Having Strong Interactive,Conceptual  and Problem Solving Skills.
          </p>
          <Link>
            <button className="btn" onClick={() => window.location.href = 'mailto:k.nagapramod28@gmail.com'}>
